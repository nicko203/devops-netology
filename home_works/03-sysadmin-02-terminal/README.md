...
Ввести данные можно перенаправив вывод на соответствующий TTY:  
**_$ echo Hello! > /dev/tty1_**  

Увидеть выведенные данные можно переключившись на соответствующий TTY. В моём случае переключение на **_tty1_** производится комбинацией клавиш Alt+Ctrl+F1.  
Графический режим: Alt+Ctrl+F7  
